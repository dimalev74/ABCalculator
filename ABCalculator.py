...
def popup_window(n1, c1, n2, c2):
    ...
    btnClosePopup = tk.Button(window, text="Зарыть", font=('Helvetica', 10, 'bold'), command=window.destroy)
...
lbTitle = tk.Label(text = "А/В калькулятор", font = ('Helvetica',16, 'bold'), fg = '#0000cc')
lbTitle.place(x=55, y=20)

# Добавление метки заголовка контрольной группы
lbTitle1 = tk.Label(text = "Контрольная группа", font = ('Helvetica',12, 'bold'), fg = '#0066ff')
lbTitle1.place(x=25, y=55)
...
lbTitle2 = tk.Label(text = "Тестовая группа", font = ('Helvetica',12, 'bold'), fg = '#008800')
lbTitle2.place(x=25, y=145)
